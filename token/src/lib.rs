...
use bunker::cache::{CacheName, CacheNamePattern};

/// Custom claim namespace for the BunkerAccess information.
///
...
pub const CLAIM_NAMESPACE: &str = "https://jwt.bunker.rs/v1";
...
struct TokenClaims {
    /// Bunker namespace.
    #[serde(rename = "https://jwt.bunker.rs/v1")]
    bunker_ns: BunkerAccess,
}

/// Permissions granted to a client.
///
/// This is the content of the `bunker-access` claim in JWTs.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct BunkerAccess {
    /// Cache permissions.
    ///
...
impl Token {
    ...
    pub fn get_or_insert_permission_mut(
        ...
        let access = self.bunker_access_mut();
    ...
    fn bunker_access(&self) -> &BunkerAccess {
        &self.0.custom.bunker_ns
    }

    fn bunker_access_mut(&mut self) -> &mut BunkerAccess {
        &mut self.0.custom.bunker_ns
    }
}
