...
pub struct StateInner {
    /// The Bunker Server configuration.
    config: Config,
...
struct RequestStateInner {
    ...
    ///
    /// This is purely informational and used to add the `X-Bunker-Cache-Visibility`.
    /// header in responses.
...
impl RequestStateInner {
    ...
    ///
    /// The APIs encompass both the Bunker API and the Nix binary
    /// cache API.
