...
//! aa Bunker server with vanilla Nix, we create a temporary root
//! for the store, as well as `nix.conf` and `netrc` configurations
//! required to connect to an Bunker server.
//!
//! ## Manual example
//!
//! ```bash
...
//!
//! ```text
//! substituters = http://localhost:8080/bunker-test
//! trusted-public-keys = bunker-test:KmfKk/KwUscRJ8obZd4w6LgaqHZcn6uhfh7FYW02DzA=
//! ```
//!
//! `netrc`:
//!
