...
impl Hash {
    ...
    pub fn from_typed(s: &str) -> BunkerResult<Self> {
    ...
    ///
    /// This is the canonical representation of hashes in the Bunker database.
...
fn decode_hash(s: &str, typ: &'static str, expected_bytes: usize) -> BunkerResult<Vec<u8>> {
