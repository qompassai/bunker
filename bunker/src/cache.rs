...
impl CacheName {
    ...
    pub fn new(name: String) -> BunkerResult<Self> {
...
impl FromStr for CacheName {
    ...
    fn from_str(name: &str) -> BunkerResult<Self> {
...
impl CacheNamePattern {
    ...
    pub fn new(pattern: String) -> BunkerResult<Self> {
...
impl FromStr for CacheNamePattern {
    ...
    fn from_str(pattern: &str) -> BunkerResult<Self> {
...
fn validate_cache_name(name: &str, allow_wildcards: bool) -> BunkerResult<()> {
    ...
    if valid {
        ...
        Err(BunkerError::InvalidCacheName {
            name: name.to_owned(),
        })
    }
}
